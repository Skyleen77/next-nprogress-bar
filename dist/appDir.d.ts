...
export declare const AppProgressBar: React.MemoExoticComponent<({ color, height, options, shallowRouting, delay, style, targetPreprocessor, }: ProgressBarProps) => React.JSX.Element>;
