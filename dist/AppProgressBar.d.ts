...
export declare const AppProgressBar: React.MemoExoticComponent<({ color, height, options, spinnerPosition, shallowRouting, disableSameURL, startPosition, delay, stopDelay, style, disableStyle, nonce, targetPreprocessor, disableAnchorClick, }: ProgressBarProps) => React.JSX.Element | null>;
